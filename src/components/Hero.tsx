...
const Hero: React.FC = () => {
  ...
  const titles = [
    ...
    "AI Project Builder with Real-World Focus",
  ];
    ...
    >
      <div className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center">
          {/* Profile Image */}
          <div
            className={`mb-8 ${animationsEnabled ? "animate-fade-in-up" : ""}`}
          >
          ...
          <div
            className={`space-y-6 ${
              animationsEnabled ? "animate-fade-in-up animation-delay-200" : ""
            }`}
          >
            ...
            <div className="h-16 flex items-center justify-center">
              <h2 className="text-2xl md:text-3xl text-blue-600 dark:text-blue-400 font-medium">
                {displayText}
                <span className={`${animationsEnabled ? "animate-pulse" : ""}`}>
                  |
                </span>
              </h2>
            </div>
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
              ...
              prototyping ML solutions for high-impact use cases. Passionate
              about transforming data into actionable insights and building
