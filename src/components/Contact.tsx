        ...
        <div ref={ref} className={`max-w-6xl mx-auto ${isInView ? 'animate-fade-in-up' : 'opacity-0'}`}>
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              ...
              or collaborating on data science initiatives
            </p>
          </div>
            ...
            <div className={`space-y-8 ${isInView ? 'animate-fade-in-left' : 'opacity-0'}`}>
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                  Whether you're looking for a data scientist to join your team, have a project 
                  you'd like to discuss, or just want to connect with a fellow AI enthusiast, 
                  I'd love to hear from you. Let's explore how we can work together to turn 
                  ...
                  {socialLinks.map((social, index) => (
                    <a
                      ...
                      className={`w-12 h-12 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg ${
                        social.color === 'blue' ? 'bg-blue-600 hover:bg-blue-700' :
                        social.color === 'gray' ? 'bg-gray-800 hover:bg-gray-900' :
