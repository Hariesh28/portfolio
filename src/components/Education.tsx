...
const Education: React.FC = () => {
  ...
  const education = {
    ...
    achievements: [
      'Maintained consistent academic excellence with 8.93 GPA',
      'Active participant in hackathons and coding competitions',
      'Member of AI & Data Science student community',
    ...
    <section id="education" className="py-20 bg-white dark:bg-gray-800">
      <div className="container mx-auto px-4">
        <div ref={ref} className={`max-w-6xl mx-auto ${isInView ? 'animate-fade-in-up' : 'opacity-0'}`}>
          ...
          {/* Education Card */}
          <div className={`bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-2xl shadow-xl overflow-hidden ${
            ...
            <div className="p-8 md:p-12">
                    ...
                    {education.coursework.map((course, index) => (
                      <div
                        ...
                        className={`flex items-center space-x-2 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors ${
                          isInView ? `animate-fade-in-left animation-delay-${300 + index * 50}` : 'opacity-0'
                        }`}
                      >
                    ...
                    {education.achievements.map((achievement, index) => (
                      <div
                        ...
                        className={`flex items-start space-x-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg ${
                          isInView ? `animate-fade-in-right animation-delay-${300 + index * 100}` : 'opacity-0'
                        }`}
                      >
              ...
              <div className="mt-8 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  My academic journey at Shiv Nadar University has provided me with a comprehensive 
                  understanding of AI and Data Science fundamentals. Through rigorous coursework and 
                  hands-on projects, I've developed expertise in machine learning algorithms, statistical 
                  analysis, and data engineering practices. I'm particularly interested in the intersection 
                  of AI and real-world applications, focusing on how data science can solve complex 
                  business problems and drive innovation across industries.
                </p>
              </div>
            </div>
          </div>
